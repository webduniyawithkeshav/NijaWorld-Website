...
import heroImg from '../assets/images/ai/digitisation.png';
            ...
            <section className="relative pt-32 pb-12 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6">
                    <div className="max-w-4xl">
                        ...
                        >
                            <span className="text-nijaGreen">Digitisation</span> for structured, usable data
                        </motion.h1>
                        <motion.p
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            Convert documents and legacy workflows into structured, usable data. Unlock the value trapped in your organization's unstructured information.
                        </motion.p>
                        <motion.div
                            initial={{ opacity: 0, y: 10 }}
                            animate={{ opacity: 1, y: 0 }}
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl">
                            Turn static documents into dynamic assets that drive business intelligence.
                        </p>
                    </motion.div>
                        ...
                        {[
                            {
                                ...
                                description: 'Instant retrieval and searchability of critical business information across the enterprise.'
                            },
                            {
                                title: 'Process Efficiency',
                                description: 'Eliminate manual data entry and reduce processing times from days to minutes.'
                            },
                            {
                                title: 'Improved Accuracy',
                                description: 'Reduce human error with automated validation and structured data extraction.'
                            },
                            {
                                title: 'Data-Driven Insights',
                                description: 'Unlock analytics and trends from previously inaccessible document data.'
                            }
                        ].map((outcome, idx) => (
                            <motion.div
                                key={idx}
            ...
            <section className="py-16 relative z-10">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl">
                            Advanced technologies to handle complex document processing needs.
                        </p>
                    </motion.div>
                        ...
                        {[
                            {
                                ...
                                description: 'High-fidelity optical character recognition for multi-format documents.'
                            },
                            {
                                title: 'Legacy Integration',
                                description: 'Seamlessly connect with existing ERP, CRM, and legacy databases.'
                            },
                            {
                                title: 'Data Structuring',
                                description: 'Transform unstructured text into JSON, XML, or database schemas.'
                            },
                            {
                                title: 'Entity Recognition',
                                description: 'Identify and classify key entities like names, dates, and amounts.'
                            },
                            {
                                title: 'Validation Rules',
                                description: 'Automated checks to ensure data integrity and compliance.'
                            },
                            {
                                title: 'Metadata Tagging',
                                description: 'Enrich documents with automated tagging for smarter categorization.'
                            }
                        ].map((feature, idx) => (
                            <motion.div
                                key={idx}
                ...
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-4 font-heading">
                            Ready to digitise your workflows?
                        </h2>
                        <p className="text-gray-300 mb-8 max-w-2xl mx-auto font-body text-lg">
                            Get in touch to see how our digitisation solutions can transform your operations.
                        </p>
