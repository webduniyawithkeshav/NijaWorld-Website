...
import heroImg from '../assets/images/cybersecurity/threat_detection.png';
        ...
        >
            ...
            <section className="relative pt-32 pb-12 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img
                        src={heroImg}
                        alt="Threat Detection Background"
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6">
                    <div className="max-w-4xl">
                        ...
                        >
                            <span className="text-nijaGreen">Threat Detection</span> & Triage
                        </motion.h1>
                        <motion.p
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            Proactive correlation and prioritisation of suspicious activity. Stop threats before they become breaches.
                        </motion.p>
                        <motion.div
                            initial={{ opacity: 0, y: 10 }}
                            animate={{ opacity: 1, y: 0 }}
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl">
                            Reduce dwell time and minimize impact.
                        </p>
                    </motion.div>
                        ...
                        {[
                            {
                                ...
                                description: 'AI-driven correlation filters out noise so analysts focus on real threats.'
                            },
                            {
                                title: 'Faster Response Time',
                                description: 'Automated triage routes high-severity alerts instantly.'
                            },
                            {
                                title: 'Comprehensive Visibility',
                                description: 'Monitor across cloud, on-prem, and endpoints in a single view.'
                            },
                            {
                                title: 'Contextual Intelligence',
                                description: 'Enrich alerts with threat intel to understand the "who" and "how".'
                            }
                        ].map((outcome, idx) => (
                            <motion.div
                                key={idx}
            ...
            <section className="py-16 relative z-10">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl">
                            Advanced analytics for the modern threat landscape.
                        </p>
                    </motion.div>
                        ...
                        {[
                            {
                                ...
                                description: 'Continuous ingest and analysis of security logs and events.'
                            },
                            {
                                title: 'Heuristic Analysis',
                                description: 'Detect unknown threats based on behavioral anomalies.'
                            },
                            {
                                title: 'Alert Prioritisation',
                                description: 'Risk-score every incident to prioritize the most critical.'
                            },
                            {
                                title: 'MITRE ATT&CK Mapping',
                                description: 'Visualize threats against known adversary tactics.'
                            },
                            {
                                title: 'User Behavior Analytics',
                                description: 'Identify compromised insiders or hijacked accounts.'
                            },
                            {
                                title: 'Threat Hunting',
                                description: 'Tools for proactive search through historical data.'
                            }
                        ].map((feature, idx) => (
                            <motion.div
                                key={idx}
                ...
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <p className="text-gray-300 mb-8 max-w-2xl mx-auto font-body text-lg">
                            Get a free threat assessment for your environment.
                        </p>
